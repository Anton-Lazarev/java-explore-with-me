...
public class BaseClient {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(
        ...
        try {
            if (params != null) {
                statisticServerResponse = rest.exchange(path, method, requestEntity, Object.class, params);
            } else {
        ...
        return prepareStatClientResponse(statisticServerResponse);
    }
    ...
    private static ResponseEntity<Object> prepareStatClientResponse(ResponseEntity<Object> response) {
